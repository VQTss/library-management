...
public class BookDAO {
    ...
    public Book findBook(String id) throws SQLException, ClassNotFoundException {
        ...
        while (rs.next()) {
            ...
            try {
                category = cDAO.findCategory(category_id);
            ...
            Book book = new Book(id, name, image, amount, category, strDate);
            return book;
        }
        return null;
    }
    ...
    public int deleteBookCategory(String category_id) throws ClassNotFoundException, SQLException {
        ...
        rdao.deleteReaderBookCategory(category_id);
