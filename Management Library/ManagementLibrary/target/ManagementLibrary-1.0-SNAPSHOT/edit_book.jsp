                    ...
                    <div class="card card-primary">
                        ...
                        <div class="row justify-content-center"
                             style="margin-top: 15px; margin-bottom: -15px;">
                                <div style="color: red;"><%=(request.getParameter("errorString") != null) ? request.getParameter("errorString") : ""%></div>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post"
                              action="BookControllers"
                            ...
                            <div class="card-footer">
                                <button type="submit" name="btnEdit" class="btn btn-primary ">Lưu</button>
                                <input type="button" value="Trở lại" class="btn btn-primary"
                                       onclick="location.href = '/Book/Manage'">
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
